...
public class TicketMasterClient {
	...
	private static final String API_KEY = "H2U7kc1Rp1oanIlGnyQOR3z2dlK4oPgs";
	
	public List<Item> search(double lat, double lon, String keyword) { // latitude, longitude and keyword
		if (keyword == null) {
			keyword = DEFAULT_KEYWORD;
		}
		try {
			keyword = URLEncoder.encode(keyword, "UTF-8"); // "Rick Sun" => "Rick%20Sun" (convert input keyword to UTF-8
		...
		try {
			...
			if (!obj.isNull("_embedded")) {
				...
				// Response structure 中有 _embedded
